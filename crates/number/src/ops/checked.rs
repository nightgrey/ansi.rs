...
pub const trait CheckedOps<Rhs = Self>:
    CheckedAdd<Rhs> + CheckedSub<Rhs> + CheckedMul<Rhs> + CheckedDiv<Rhs> + CheckedNeg<Rhs>
{
}

pub const trait CheckedAdd<Rhs = Self>: Sized + Add<Rhs, Output = Self> {
...
pub const trait CheckedSub<Rhs = Self>: Sized + Sub<Rhs, Output = Self> {
...
/// overflow.
pub const trait CheckedMul<Rhs = Self>: Sized + Mul<Rhs, Output = Self> {
...
pub const trait CheckedDiv<Rhs = Self>: Sized + Div<Rhs, Output = Self> {
...
pub const trait CheckedRem<Rhs = Self>: Sized + Rem<Rhs, Output = Self> {
...
pub const trait CheckedNeg<Rhs = Self>: Sized {
...
pub const trait CheckedShl<Rhs = u32>: Sized + Shl<Rhs, Output = Self> {
...
/// or equal to the type width.
pub const trait CheckedShr<Rhs = u32>: Sized + Shr<Rhs, Output = Self> {
